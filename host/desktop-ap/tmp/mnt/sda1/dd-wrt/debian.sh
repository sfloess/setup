...
start() {
	...
	#mkdir -p ${CHROOT_DIR}/mnt/desktop-ap/sda
	#mount -o bind /tmp/mnt/sda1/exports ${CHROOT_DIR}/mnt/desktop-ap/sda 
	
	#mkdir -p ${CHROOT_DIR}/mnt/desktop-ap/sdb
	#mount -o bind /tmp/mnt/sdb1/exports ${CHROOT_DIR}/mnt/desktop-ap/sdb 
